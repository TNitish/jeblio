...
const projects = [
  {
    ...
    image: "https://via.placeholder.com/600x400/6D28D9/FFFFFF?text=TutAI",
    category: "web",
  ...
  },
  {
    ...
    title: "HealthTrack",
    description:
      "A comprehensive health monitoring application for tracking fitness goals and medical records.",
    image: "https://via.placeholder.com/600x400/EC4899/FFFFFF?text=HealthTrack",
    category: "mobile",
  ...
  },
  {
    ...
    title: "SmartRetail",
    description:
      "An inventory management system with predictive analytics for retail businesses.",
    image: "https://via.placeholder.com/600x400/0EA5E9/FFFFFF?text=SmartRetail",
    category: "web",
  ...
  },
  {
    ...
    title: "TravelBuddy",
    description:
      "A travel companion app that offers personalized recommendations and itinerary planning.",
    image: "https://via.placeholder.com/600x400/10B981/FFFFFF?text=TravelBuddy",
    category: "mobile",
