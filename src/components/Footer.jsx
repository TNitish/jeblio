...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/jeblio_official?igsh=MW5pNWMyeThyMXI3ZA==" className="text-gray-400 hover:text-pink-400 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <p href="#" className="text-gray-400 hover:text-pink-400 transition-colors">
                  Web Development
                </p>
              </li>
              <li>
        ...
        <div className="border-t border-white/10 mt-12 pt-6 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-sm text-gray-400">&copy; {new Date().getFullYear()} Jeblio. All rights reserved.</p>
          <div className="flex gap-4 mt-4 sm:mt-0">
            <p href="#" className="text-sm text-gray-400 hover:text-pink-400 transition-colors">
              Privacy Policy
            </p>
            <p href="#" className="text-sm text-gray-400 hover:text-pink-400 transition-colors">
              Terms of Service
